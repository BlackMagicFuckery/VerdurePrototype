#--------------------------------------
#Verdure Systems Prototype 1.0 9/9/2017 start
...
print time.strftime("%Y%m%d%H%M%S")# time.strftime("%H:%M:%S")
...
#  print "Version     :", chip_version
  ...
  print "Air Temperature : ", int(temp_air), "C"
  print "Air Pressure : ", int(pressure), "kPa"
  print "Air Humidity : ", int(humidity), "%"

# below is from github, modified slightly
...
print "Full Spectrum(IR+Visible) :%d lux" %full_lux
print "IR Value :%d lux" %ir_lux
print "Visible Value :%d lux" %vis_lux


#f=open('dfwaqua1.csv','a')
#f.write()
#f.close()

#dfwaquadata = [[0,1,2,3,4,5,6],[time.strftime("%Y%m%d%H%M%S"),full_lux,ir_lux,vis_lux,temp_air,pressure,humidity]]
#dfwaquafile = open('dfwaqua1.csv', 'w')
# with dfwaquafile:
